...
--
-- Table structure for table `character_transmog_limit`
--

DROP TABLE IF EXISTS `character_transmog_limit`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `character_transmog_limit` (
  `guid` int(10) unsigned NOT NULL,
...
--
-- Dumping data for table `character_transmog_limit`
--

LOCK TABLES `character_transmog_limit` WRITE;
/*!40000 ALTER TABLE `character_transmog_limit` DISABLE KEYS */;
/*!40000 ALTER TABLE `character_transmog_limit` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-02-11 23:59:10
